...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing Super-Bombing'
    else
                 figlet Super-Bombing
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mKai 0071 \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        figlet Kai
    printf "\033[1;93m[\033[1;77m::\033[1;93m]	    \033[1;92m   Code by : \033[1;97m   Kai	    \033[1;93m[\033[1;77m::\033[1;93m]"
	printf "\n\033[1;93m[\033[1;77m::\033[1;93m]	\033[1;92mmodify code by : \033[1;97m Kai 0071 \033[1;93m[\033[1;77m::\033[1;93m]\n"
    echo " "
    echo " "
    echo -e            *Requirements:*
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Kai > .update
...
do
    ...
    echo " "
    echo -e "'\033[1;31m                           ⫸ Coded by\033[1;32m Kai\033[1;31m ⫷\033[0m"
    echo -e "'\033[1;31m                         ⫸\033[1;33m Kai\033[1;31m ⫷\033[0m"
    echo 
...
echo " "
   ...
   if [ $ch -eq 1 ];then
        ...
        cd $HOME
        rm -rf Super-Bombing
        https://github.com/Kai0071/Super-Bombing
        cd Super-Bombing
        bash Super-Bombing.sh
