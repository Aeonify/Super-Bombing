...
def check_for_updates():
    ...
    fver = requests.get(
        "https://github.com/Kai0071/Super-Bombing/blob/main/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Super-Bombing was created by Kai")
    mesgdcrt.SuccessMessage("Super-Bombing was modified by Kai")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("Super-Bombing will work only in Python v3")
    sys.exit()
...
description = """Super-Bombing - Your Friendly Spammer Application

 Super-Bombing can be used for many purposes which incudes -
